        ...
        child: SafeArea(
          child: Stack(
            children: [
              ...
              const Positioned(top: 40, left: 22, child: Opacity(opacity: 0.85, child: FruitImage(index: 0, size: 34))),
              const Positioned(top: 90, right: 26, child: Opacity(opacity: 0.85, child: FruitImage(index: 2, size: 28))),
              const Positioned(top: 140, left: 44, child: Opacity(opacity: 0.7, child: FruitImage(index: 3, size: 24))),
                    ...
                    Column(
                      children: [
                        Text(
                          ...
                          style: TextStyle(fontWeight: FontWeight.w700, fontSize: 34, letterSpacing: 0.6, color: AppColors.coral, shadows: const [
                            Shadow(color: Colors.white, offset: Offset(2, 2)),
                            Shadow(color: Color(0x40FF6B4A), offset: Offset(4, 4)),
                          ]),
                        ),
                        const SizedBox(height: 2),
                        const Text('ADVENTURE', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 22, letterSpacing: 3, color: AppColors.text)),
                      ],
                    ),
...
class _MenuLink extends StatelessWidget {
  ...
  const _MenuLink({required this.icon, required this.label, required this.onTap});
